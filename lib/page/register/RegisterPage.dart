...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext contexts) {
    ...
    return BlocProvider(
        ...
        child: Material(
            child: Stack(
                children: [RegisterWidget(), IndicatorView<RegisterCubit>()])));
  }
}
...
class RegisterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<RegisterCubit>(context).init(context);
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () =>
                  BlocProvider.of<RegisterCubit>(context).back(context),
              child: Padding(
                padding:
            ...
            child: SingleChildScrollView(
              child:
                ...
                RoundedInputField(
                  ...
                  onChanged: (value) =>
                      BlocProvider.of<RegisterCubit>(context).changName(value),
                ),
                Container(
                  ...
                  child: VerificationCode<RegisterCubit>(
                      ...
                      () => BlocProvider.of<RegisterCubit>(context).sendCode(context),
                      kPrimaryColor: Theme.of(context).accentColor,
                      onChanged: (String code) => BlocProvider.of<RegisterCubit>(context).changCode(code),),
                ),
                RoundedPasswordField(
                  kPrimaryColor: Theme.of(context).accentColor,
                  hintText:
                      Translations.of(context).text(Constant.loginPassWordText),
                  onChanged: (value) => BlocProvider.of<RegisterCubit>(context)
                      .changPassWord(value),
                ),
                RoundedButton(
                  color: Theme.of(context).accentColor,
                  text: Translations.of(context).text(Constant.register),
                  press: () =>
