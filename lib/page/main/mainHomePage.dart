  ...
  return Row(
    children: [
      ...
      Expanded(child: Center(
        child: BlocBuilder<MainHomeBloc, MainHomeState>(builder: (context, state) {
          ///看这看这：刷新组件！
...
Widget navigationRailSide() {
      ...
      builder: (context, state) {
        return FloatingActionButton(
          onPressed: () {
            ...
            BlocProvider.of<MainHomeBloc>(context).add(IsExtendEvent());
          },
          ///看这看这：刷新组件！
  ...
  return BlocBuilder<MainHomeBloc, MainHomeState>(builder: (context, state) {
    return NavigationRail(
      ...
      onDestinationSelected: (int index) {
        ///添加切换tab事件
        BlocProvider.of<MainHomeBloc>(context).add(SwitchTabEvent(selectedIndex: index));
      },
    );
  });
}